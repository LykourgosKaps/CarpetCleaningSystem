...
namespace CarpetCleaningSystem.Infrastructure.Repositories
{
    public class OrderRepository : IOrderRepository
    {
        ...
        public async Task<List<Order>> ListAsync(OrderStatus? status, CancellationToken ct)
        {
        ...
        public async Task<Order?> GetLatestByCustomerIdAsync(int customerId, CancellationToken ct)
        {
            return await _context.Orders
